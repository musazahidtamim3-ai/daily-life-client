...
import { createSubscription } from '@/lib/actions/submit/subscription';
          ...
          <div className="w-full min-h-screen bg-zinc-950 text-zinc-50 flex flex-col justify-center items-center p-6 select-none relative overflow-hidden">
               ...
               >
                    ...
                    <div className="bg-zinc-950/60 border border-zinc-800/80 rounded-xl p-4 text-left space-y-3.5 text-xs mb-8">
                         <div className="flex items-start gap-2.5">
                              ...
                              <div>
                                   ...
                                   {/* Show customerEmail in UI (what Stripe collected) — this is fine for display */}
                    ...
                    <div className="space-y-3">
                         <Link
                              href="/dashboard"
                              className="block w-full text-center text-xs font-semibold px-4 py-3 bg-linear-to-l from-indigo-500 to-purple-500 hover:bg-blue-500 text-white rounded-xl shadow-lg shadow-blue-950/30 transition duration-200"
                         >
