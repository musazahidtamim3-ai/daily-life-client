...
export default function ProfilePage() {
     ...
     const userLessons = [
          { id: 1, title: "What 5 Years in Tech Taught Me About Patience", category: "Career", date: "June 18, 2026", likes: 142 },
          { id: 2, title: "The Art of Saying No Without Feeling Guilty", category: "Mindset", date: "June 10, 2026", likes: 98 },
          { id: 3, title: "Why Chasing Perfection Will Ruin Your First Project", category: "Mistakes", date: "May 28, 2026", likes: 230 },
     ];
     ...
     return (
          <div className="space-y-2 max-w-5xl mx-auto relative z-10">
                         ...
                         <div className="flex flex-col sm:flex-row items-center sm:items-end justify-between gap-6 -mt-12 mb-6">
                              <div className="flex flex-col sm:flex-row items-center sm:items-end gap-5 text-center sm:text-left">
                                   <Image
                                        ...
                                        className="w-24 h-24 rounded-md sm:w-28 sm:h-28 text-large border-4 border-[#0c0c0e] shadow-xl"
                                   />
               ...
               <div className="space-y-6">
                    <div className="flex items-center gap-2 border-b border-neutral-800/60 pb-3">
                         ...
                         <span className="text-xs font-mono bg-neutral-900 text-neutral-500 px-2 py-0.5 rounded-md">({userLessons.length})</span>
                    </div>

                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                         {userLessons.map((lesson) => (
                              <Card key={lesson.id} className="border border-neutral-800/80 bg-[#0c0c0e]/50 p-5 flex flex-col justify-between" shadow="none">
                                   <div className="space-y-3">
                                        <div className="flex items-center justify-between">
                                             <Chip size="sm" variant="flat" color="secondary" className="bg-purple-500/10 text-purple-400 font-mono text-[10px]">
                                                  {lesson.category}
                                             </Chip>
                                             <span className="text-xs text-neutral-500 font-mono">{lesson.date}</span>
                                        </div>
                                   ...
                                   <div className="flex items-center justify-between pt-5 mt-4 border-t border-neutral-900">
                                        <span className="text-xs text-neutral-400 flex items-center gap-1.5">
                                             <Heart className="w-3.5 h-3.5 text-pink-500" /> {lesson.likes} favorites
                                        </span>
                                        <div className="flex items-center gap-1">
                                             ...
                                             <button className="p-1.5 rounded-lg text-neutral-500 hover:text-danger transition-colors"><TrashBin className="w-4 h-4" /></button>
                                        </div>
                                   </div>
                              </Card>
                         ))}
                         ...
                         <div className="bg-[#0c0c0e] border border-neutral-800 text-white rounded-2xl w-full max-w-md overflow-hidden relative z-10 shadow-2xl animate-in fade-in zoom-in-95 duration-150">
                              ...
                              <div className="py-4 px-6 space-y-5">
                                   ...
                                   <div className="space-y-1.5">
                                        ...
                                        <input
                                             ...
                                             className="w-full bg-[#121214] border border-neutral-800 rounded-xl px-3 py-2.5 text-sm text-white placeholder-neutral-600 focus:outline-none focus:border-purple-500 transition-colors"
                                        />
                                   </div>
                                   ...
                                   <div className="space-y-1.5">
                                        ...
                                        <div className="relative flex items-center">
                                             <input
                                                  ...
                                                  className="w-full bg-[#121214] border border-neutral-800 rounded-xl pl-3 pr-10 py-2.5 text-sm text-white placeholder-neutral-600 focus:outline-none focus:border-purple-500 transition-colors"
                                             />
                              ...
                              <div className="border-t border-neutral-900 p-6 flex items-center justify-end gap-3">
                                   <button
                                        ...
                                        className="px-4 py-2 text-sm font-medium text-neutral-400 hover:text-white rounded-xl hover:bg-neutral-900 transition-colors"
                                   >
                                        Cancel
                                   </button>
                                   <button
                                        onClick={handleSaveChanges}
                                        className="px-5 py-2 text-sm font-semibold bg-linear-to-l from-indigo-500 to-purple-500 hover:bg-blue-700 text-white rounded-xl shadow-md active:scale-95 transition-all"
                                   >
                                        Save Changes
                                   </button>
                              </div>
